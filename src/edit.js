...
import {
	...
	ToggleControl,
	Button,
	/* eslint-disable @wordpress/no-unsafe-wp-apis -- ToolsPanel and UnitControl remain experimental in @wordpress/components with no stable equivalent (verified WP docs 2026-06-17). */
				...
				<ToolsPanel
					...
					resetAll={() => {
						setAttributes({
							...
							labelText: __('Search for:', 'search-modal-block'),
							showLabel: false,
						});
					}}
				>
